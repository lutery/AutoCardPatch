...
}if(this._clientDataSourceID){var h=$find(this._clientDataSourceID);
this._initializeClientDataSource(h);
...
},set_clientDataSource:function(h){this._initializeClientDataSource(h);
...
b.RadComboBox.prototype._initializeClientDataSource=function(d){this._clientDataSource=d;
};
...
if(d!=null){this._pendingAjaxRequestsCount--;
this._addNewItems(text,d);
return;
...
(function() {
    function loadHandler() {
        ...
        hf.value += ';;System.Web.Extensions, Version=3.5.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35:zh-CN:16997a38-7253-4f67-80d9-0cbcc01b3057:ea597d4b:b25378d2;Telerik.Web.UI, Version=2014.2.724.35, Culture=neutral, PublicKeyToken=121fae78165ba3d4:zh-CN:b3bb75dd-6103-4997-8feb-efbc43ce5875:16e4e7cd:86526ba7:f7645509:24ee1bba:11a04f7e:f46195d3:2003d0b8:88144a7a:1e771326:aa288e2d:258f1c72:874f8ea2:c128760b:19620875:92fe8ea0:fa31b949:490a9d4e:bd8f85e4';                                    
