...
| 010001 |  | 3a1d6493-c21f-437e-9622-7e0b29b3622e | /HR |

2. 代码
```javascript
function doLogin(rsa_E, rsa_M, randSeed, applicationPath) {
    setMaxDigits(131);
    var key = new RSAKeyPair(rsa_E, "", rsa_M);
    var base64 = new Base64();
    var username = $("#edtUserName").val();
    var password = $("#edtPassWord").val();
    var platform = $("#ddl1").val();
    var passport = encryptedString(key, base64.encode(username) + "/" + base64.encode(password) + "/" + base64.encode(randSeed) + "/" + base64.encode(platform));
    var htmlobj = $.ajax({ url: applicationPath + "/login.aspx?ls=" + passport, async: false });
